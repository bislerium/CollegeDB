...
CREATE TABLE address (
    ...
    city_locality VARCHAR2(80) NOT NULL,
    street_name   VARCHAR2(80) NOT NULL
);
...
CREATE TABLE department (
    ...
    department_location VARCHAR2(30) NOT NULL,
...
CREATE TABLE student_attendance (
    student_id        INTEGER NOT NULL,
    attendance_id     INTEGER NOT NULL,
    attendance_status VARCHAR2(8) NOT NULL
);
